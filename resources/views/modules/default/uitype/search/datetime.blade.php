...
<div class="relative flex flex-row items-center mt-2">
    ...
    <input type="date" class="w-full h-8 pl-10 bg-white border border-gray-200 rounded-lg shadow-sm" autocomplete="off" wire:model.debounce.500ms="search.{{ $field->name }}">
</div>
